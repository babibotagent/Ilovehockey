...
const translations: Record<string, Record<Lang, string>> = {
  ...
  "historia.subtitle": {
    ...
    fr: "Cinq Coupes du Monde. Des générations de stars. L'histoire la plus glorieuse du football mondial.",
    es: "Cinco Copas del Mundo. Generaciones de estrellas. La historia más gloriosa del fútbol mundial.",
  },
